...
class PerceptionNode(Node):
    def __init__(self):
        super().__init__('task3b_perception_node')
        ...
        self.create_subscription(Image, '/camera/image_raw', self.color_image_callback, 10, callback_group=self.cb_group)
        self.create_subscription(Image, '/camera/depth/image_raw', self.depth_image_callback, 10, callback_group=self.cb_group)
        self.camera_info_sub = self.create_subscription(CameraInfo, '/camera/camera_info', self.camera_info_callback, 10, callback_group=self.cb_group)
